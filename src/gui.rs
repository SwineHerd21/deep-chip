        ...
        .show(ctx, |ui| {
            egui::menu::bar(ui, |ui| {
                ...
                ui.menu_button("Quirks", |ui| {
                    ...
                    ).on_hover_text("If true, the Fx55 and Fx65 opcodes will set I to I + x + 1.\nIf false, the Fx55 and Fx65 opcodes will set I to I + x.");
                    ui.checkbox(
                ...
                ui.menu_button("Settings", |ui| {
                    ...
                    ui.checkbox(show_state, "Show interpreter state");
                    ui.checkbox(show_keys, "Show keypad");
                    ui.checkbox(show_ram, "Show RAM");
    ...
    egui::TopBottomPanel::top("control panel")
        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui
                    .add_enabled(!interpreter.running(), Button::new("Step cycle"))
                ...
                if ui
                    .add_enabled(!interpreter.running(), Button::new("Step frame"))
                ...
                if ui
                    .add_enabled(!interpreter.running(), Button::new("Reset"))
                    .clicked()
                {
                    interpreter.reset();
                    interpreter.load_program(&rom);
...
#[inline]
pub fn draw_registers(interpreter: &Chip8, ctx: &egui::Context) {
    egui::SidePanel::right("registers")
        .show_separator_line(true)
        .resizable(false)
        .default_width(100.0)
        .show(ctx, |ui| {
            ui.spacing_mut().item_spacing = egui::vec2(5.0, 1.5);
            ui.add_space(5.0);
            ...
            ui.scope_builder(egui::UiBuilder::new(), |ui| {
                ...
                ui.horizontal(|ui| {
                    ui.label("Delay: ");
                    ui.colored_label(Color32::YELLOW, format!("{:02X}", interpreter.get_delay()));
                });
                ui.horizontal(|ui| {
                    ui.label("Sound: ");
                    ui.colored_label(Color32::YELLOW, format!("{:02X}", interpreter.get_sound()));
                });
            });
        });
}
...
pub fn draw_ram(interpreter: &Chip8, ctx: &egui::Context) {
    egui::TopBottomPanel::bottom("ram")
        .show_separator_line(true)
        .default_height(200.0)
        .resizable(true)
        .show(ctx, |ui| {
            ui.label(RichText::new("RAM").heading());
            ui.separator();
            ui.spacing_mut().scroll = ScrollStyle::solid();
            ScrollArea::vertical()
                .scroll([false, true])
...
#[inline]
pub fn draw_keypad(interpreter: &Chip8, ctx: &egui::Context) {
    egui::SidePanel::left("keypad")
        .show_separator_line(true)
        .exact_width(180.0)
        .resizable(false)
        .show(ctx, |ui| {
            ui.add_space(5.0);
            ui.label(RichText::new("Keypad").heading());
            ui.separator();
            ui.add_space(5.0);
...
fn draw_key(ui: &mut egui::Ui, text: &str, key: bool) {
    Frame::default()
        .inner_margin(Margin::symmetric(13.5, 10.0))
